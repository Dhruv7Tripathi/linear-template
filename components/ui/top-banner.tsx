...
export default function TopBanner() {
  ...
  return (
    <div className="lg:w-full relative z-[60] dark:bg-white bg-black text-white dark:text-black  sm:px-6 md:px-8 lg:px-12 py-2 md:py-2.5 lg:py-3 flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-3 md:gap-4">
      {/* Text + Link Section */}
      ...
      <div className=" gap-2 sm:gap-2.5 md:gap-3">
        <Link
          href="https://www.layrdui.in/templates/linear-template"
          target="_blank"
