...
export const Navbar = () => {
  ...
  return (
    <nav
      className={cn(
        "w-full z-50 transition-all duration-300 border-b  border-neutral-200 dark:border-neutral-800/50 bg-neutral-200/40 dark:bg-neutral-900/40  backdrop-blur-md"
