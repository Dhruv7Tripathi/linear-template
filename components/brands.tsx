...
import { SiHp, SiDell, SiXiaomi, SiJbl, SiAsus, SiEpson, SiLapce } from "react-icons/si";

const brands = [
  { name: "EPSON", icon: <SiEpson size={70} /> },
...
export default function SelectedBrands() {
  return (
    <section className="py-10 mt-16 flex justify-center bg-white dark:bg-black text-center">
